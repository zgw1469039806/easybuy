			...
			<form action="/upPrCat">
				<table class="form">
					<c:forEach items="${bid}" var="b">
						<tr>
							<td class="field">商品编号：${b.id}</td>
							<td><input type="text" name="id" hidden id="id" value="${b.id}"></td>
						</tr>

						<tr>
							<td class="field">商品名称(*)：</td>
							<td><input type="text" class="text" name="name" value="${b.name}" /></td>
						</tr>
						<tr>
							<td class="field">描述：</td>
							<td><input type="text" class="text" name="description" value="${b.description}"/></td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td><input type="text" class="text tiny" name="price" value="${b.price}"/> 元</td>
						</tr>

						<tr>
							<td class="field">库存(*)：</td>
							<td><input type="text" class="text tiny" name="stock" value="${b.stock}" /></td>
						</tr>
						<tr>
							<td class="field">商品图片：</td>
							<td><input type="file" class="text" name="fileName" value="${b.fileName}" /></td>
						</tr>
						<tr>
							<td></td>
