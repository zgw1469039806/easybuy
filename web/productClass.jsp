	...
	<div class="main">
		...
		<div class="manage">
			<table class="list">
				...
				<c:forEach var="pct" items="${proCateTypes}">
					<tr>
						<td class="first w4 c">${pct.id}</td>
						<td>${pct.cname}</td>
						<td class="w1 c"><a href="/qbyid?id=${pct.id}">修改</a>
							<a class="manageDel" href="/dels?id=${pct.id}">删除</a></td>
					</tr>
				</c:forEach>
				<%--<tr>--%>
