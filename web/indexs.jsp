...
<div id="header" class="wrap">
	...
	<div class="navbar">
		<ul class="clearfix">
			<li class="current"><a href="indexs.jsp">首页</a></li>
	...
	<div id="menu-mng" class="lefter">
		<div class="box">
			<dl>
			  ...
			  <dt>商品信息</dt>
				<dd><em><a href="productClass-add.jsp">新增</a></em><a href="/proType">分类管理</a></dd>
				<dd><em><a href="productClass.jsp">新增</a></em><a href="/quePro">商品管理</a></dd>
				<dt>订单管理</dt>
